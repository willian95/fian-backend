        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-custom bg-info">
                    ...
                    <div class="card-body text-white">
                        <h3 class="text-center">{{ App\Models\Market::count() }} </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-custom bg-success">
                    ...
                    <div class="separator separator-solid separator-white opacity-20"></div>
                    <div class="card-body text-white">
                        <h3 class="text-center">{{ App\Models\FarmActivityEvent::count() }} </h3>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ url('/market') }}" class="btn btn-info font-weight-bolder font-size-sm">Nuevo mercado</a>
                        </div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                    <div class="card-body py-0">
                        ...
                        <div class="table-responsive">
                            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                                ...
                                <tbody>
                                    @foreach(App\Models\Market::orderBy("id", "desc")->with("department")->limit(5)->get() as $market)
                                        <tr>
                                            <td>{{ $market->name }}</td>
