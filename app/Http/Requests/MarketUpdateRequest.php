...
class MarketUpdateRequest extends FormRequest
{
    ...
    {
        return [
            "selectedId" => "required|exists:markets,id",
    ...
    {
        return [
            "selectedId.required" => "Debe seleccionar un mercado para actualizar",
            "selectedId.exists" => "Mercado seleccionado no es válido",
